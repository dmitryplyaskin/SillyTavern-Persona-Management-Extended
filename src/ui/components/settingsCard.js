...
export function createSettingsCard() {
  ...
  header.appendChild(el("div", "pme-card-title", t`Settings`));
  ...
  wrapperTitleRow.appendChild(el("div", "pme-settings-label", t`Wrapper`));
  ...
  wrapperToggleLabel.appendChild(el("span", "", t`Enabled`));
  ...
  wrapperMaxBtn.title = t`Expand the editor`;
  ...
  const wrapperHelp = el(
    ...
    t`When enabled, the final persona prompt generated by PME will be inserted into this template by replacing {{PROMPT}}.`
  );
  ...
  joinerRow.appendChild(
    el("div", "pme-settings-label", t`Additional Descriptions joiner`)
  );
  ...
  const joinerHelp = el(
    "div",
    "text_muted pme-settings-help",
    t`String used to join enabled Additional Descriptions blocks. Supports escape sequences like \n, \t, \r, and \\\\.`
  );
